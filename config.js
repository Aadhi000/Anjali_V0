...
module.exports = {
    ...
    SESSION: process.env.MAALUTTY_SESSION === undefined ? '' : process.env.MAALUTTY_SESSION,
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'MADE BY ANJALI' : process.env.ALL_CAPTION,
    ...
    BOT: process.env.BOT_NAME === undefined ? '⊢‒‒‒ ⋈ ANJALI ⋈ ‒‒‒⊣' : process.env.BOT_NAME,
